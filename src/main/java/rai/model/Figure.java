...
public class Figure {
  ...
  public Figure(double xUpLeft, double xDownLeft, double xUpRight, double xDownRight, double yUp, double yDown, Figure childLeft, Figure childRight) {
    leftWall = LineManager.getInstance().createLineFunction(xUpLeft, yUp, xDownLeft, yDown);
    rightWall = LineManager.getInstance().createLineFunction(xUpRight, yUp, xDownRight, yDown);
